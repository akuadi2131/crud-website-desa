...
<body>
        ...
        <div class="container py-3">
            <div class="d-flex align-items-center">
                ...
                <div class="ms-auto d-flex align-items-center">
                    ...
                    <!-- <small class="ms-4"><i class="fa fa-phone-alt me-3"></i>+62 8910111213</small> -->
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="{{ asset('storage') }}/assets/img/rumahrumah.jpeg" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-7 text-start">
                                    <p class="fs-4 text-white animated slideInRight">Selamat Datang di 
                                        <strong>DESA ANJUN</strong>
                                    </p>
                                    <h1 class="display-1 text-white mb-4 animated slideInRight">Kami siap melayani sepenuh hati.</h1>
                                    <!-- <a href=""
                                        class="btn btn-primary rounded-pill py-3 px-5 animated slideInRight">Jelajahi</a> -->
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="carousel-item">
                    <img class="w-100" src="{{ asset('storage') }}/assets/img/rumahrumah2.jpeg" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-end">
                                <div class="col-lg-7 text-end">
                                    <p class="fs-4 text-white animated slideInLeft">Selamat Datang di <strong>DESA ANJUN</strong>
                                    </p>
                                    <h1 class="display-1 text-white mb-5 animated slideInLeft">Kami siap melayani sepenuh hati.</h1>
                                    <!-- <a href=""
                                        class="btn btn-primary rounded-pill py-3 px-5 animated slideInLeft">Jelajahi</a> -->
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.1s">
                    <div class="feature-item border h-100 p-5">
                        <div class="btn-square bg-light rounded-circle mb-4" style="width: 64px; height: 64px;">
                            <img class="img-fluid" src="{{ asset('storage') }}/assets/img/icon/icon-1.png" alt="Icon">
                        </div>
                        <h5 class="mb-3">Pelayanan</h5>
                        <p class="mb-0">Memiliki pelayanan yang berkualitas untuk melayani masyarakat.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.3s">
                    <div class="feature-item border h-100 p-5">
                        <div class="btn-square bg-light rounded-circle mb-4" style="width: 64px; height: 64px;">
                            <img class="img-fluid" src="{{ asset('storage') }}/assets/img/icon/icon-2.png" alt="Icon">
                        </div>
                        <h5 class="mb-3">Staff Professional </h5>
                        <p class="mb-0">Memiliki staff professional untuk melayani masyarakat dengan baik.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.5s">
                    <div class="feature-item border h-100 p-5">
                        <div class="btn-square bg-light rounded-circle mb-4" style="width: 64px; height: 64px;">
                            <img class="img-fluid" src="{{ asset('storage') }}/assets/img/icon/icon-3.png" alt="Icon">
                        </div>
                        <h5 class="mb-3">Keuangan</h5>
                        <p class="mb-0">Memiliki pengelolaan keuangan dengan baik, dan tepat sasaran kepada masyarakat.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.7s">
                    <div class="feature-item border h-100 p-5">
                        <div class="btn-square bg-light rounded-circle mb-4" style="width: 64px; height: 64px;">
                            <img class="img-fluid" src="{{ asset('storage') }}/assets/img/icon/icon-4.png" alt="Icon">
                        </div>
                        <h5 class="mb-3">24/7</h5>
                        <p class="mb-0">Selalu bersedia melayani masyarakat setiap saat.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-0">
                <div class="col-lg-6">
                    <div class="h-100 d-flex align-items-center justify-content-center" style="min-height: 300px;">
                        <button type="button" class="btn-play" data-bs-toggle="modal"
                            data-src="https://www.youtube.com/watch?v=dqywiC8JN4M" data-bs-target="#videoModal">
                            <span></span>
                        </button>
                    </div>
                </div>
                <div class="col-lg-6 pt-lg-5 wow fadeIn" data-wow-delay="0.5s">
                    <div class="bg-white rounded-top p-5 mt-lg-5">
                        <p class="fs-5 fw-medium text-primary">Tentang</p>
                        <h1 class="display-6 mb-4">Daya Tarik Desa Anjun</h1>
                        <p class="mb-4">Desa Anjun yang terletak di Daerah Plered Purwakarta, terkenal akan kerajinan keramik atau gerabah yang terbuat dari tanah liat. Gerabag Plered, Purwakarta sudah terkenal hingga ke pasar Asia hingga Eropa.
                        </p>
                        <br>
                        <p class="mb-4">Dan fun fact Kerajinan keramik atau gerabah sudah ada sejak beberapa abad yang lalu, di Indonesia sendiri sudah ada sejak zaman kolonial Belanda. Yakni sekitar tahun 1795, di daerah Citalang, yang menjadi pusat pembuatan batu bata dan genteng.
                        </p>
                        <div class="row g-5 pt-2 mb-5">
                            <!-- <div class="col-sm-6">
                                <img class="img-fluid mb-4" src="{{ asset('storage') }}/assets/img/icon/icon-5.png" alt="">
                                <h5 class="mb-3">Sosial Media</h5>
                                <span>Bisa cek di sosial media kearifan local yang ada di desa anjun ini.</span>
                            </div>
                            <div class="col-sm-6">
                                <img class="img-fluid mb-4" src="{{ asset('storage') }}/assets/img/icon/icon-2.png" alt="">
                                <h5 class="mb-3">Skill</h5>
                                <span>Pengrajin keramik ini harus memiliki skill yang mempuni, sebab pembuatannya membutuhkan ketelitian dan keahlian tingkat tinggi.</span>
                            </div> -->
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content rounded-0">
                ...
                <div class="modal-body">
                    ...
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/f6QsJhNUM1c?si=iJn6IHCUbDJLC9hK" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-xxl pt-5">
        <div class="container">
            <div class="text-center text-md-start pb-5 pb-md-0 wow fadeInUp" data-wow-delay="0.1s"
                ...
                <p class="fs-5 fw-medium text-primary">Tentang</p>
                <h1 class="display-5 mb-5">Wisata yang Ada di Desa Anjun</h1>
            </div>
            <div class="owl-carousel project-carousel wow fadeInUp" data-wow-delay="0.1s">
                <div class="project-item mb-5">
                    <div class="position-relative">
                        <img class="img-fluid" src="{{ asset('storage') }}/assets/img/orang.jpeg" alt="">
                    ...
                    <div class="p-4">
                        <a class="d-block h5" href="">Museum Keramik</a>
                        <span>Kerajinan keramik atau gerabah sudah ada sejak beberapa abad yang lalu, di Indonesia sendiri sudah ada sejak zaman kolonial Belanda.</span>
                    </div>
                </div>
                <div class="project-item mb-5">
                    <div class="position-relative">
                        <img class="img-fluid" src="{{ asset('storage') }}/assets/img/hutanpelangi2.jpg" alt="">
                        <div class="project-overlay">
                    ...
                    <div class="p-4">
                        <a class="d-block h5" href="">Hutan Pelangi</a>
                        <span>Hutan Pelangi salah satu destinasi wisata yang ada di kaki Gunung Cupu, tepatnya sebelah barat Desa Anjun Kecamatan Plered Purwakarta</span>
                    </div>
                </div>
                <div class="project-item mb-5">
                    <div class="position-relative">
                        <img class="img-fluid" src="{{ asset('storage') }}/assets/img/gunungcupu2.jpg" alt="">
                        <div class="project-overlay">
                    ...
                    <div class="p-4">
                        <a class="d-block h5" href="">Gunung Cupu</a>
                        <span> meski tidak terlalu tinggi, tapi medan yang ditempuh untuk mencapai puncak gunung cukup menguji adrenaline.</span>
                    </div>
                </div>
                <!-- <div class="project-item mb-5">
                    <div class="position-relative">
                        <img class="img-fluid" src="{{ asset('storage') }}/assets/img/project-4.jpg" alt="">
                        <div class="project-overlay">
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <p class="fs-5 fw-medium text-primary">Kelompok</p>
                <h1 class="display-5 mb-5">Website Desa</h1>
            </div>
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item rounded overflow-hidden pb-4">
                        <img class="img-fluid mb-4" src="{{ asset('storage') }}/assets/img/adi.jpg.jpeg" alt="">
                        <h5>Muhamad Adi Wijaya</h5>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item rounded overflow-hidden pb-4">
                        <img class="img-fluid mb-4" src="{{ asset('storage') }}/assets/img/nabila.jpg.jpeg" alt="">
                        <h5>Nabila Mustika Ayu</h5>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item rounded overflow-hidden pb-4">
                        <img class="img-fluid mb-4" src="{{ asset('storage') }}/assets/img/dudun.jpg.jpeg" alt="">
                        <h5>Lisfaro Dudun</h5>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item rounded overflow-hidden pb-4">
                        <img class="img-fluid mb-4" src="{{ asset('storage') }}/assets/img/naura.jpg.jpeg" alt="">
                        <h5>Naura Afnandita</h5>
